...
contract Ownable is StringTools {
...
contract AccessControl is Ownable {
    ...
    constructor() public {
        MainAdmin = owner;
        TechnicalAdmin = owner;
        FinancialAdmin = owner;
        MarketingAdmin = owner;
    }
...
contract FootballPlayerBase is PullPayment, ERC721 {
    ...
    function GetPlayer(uint256 _playerId) external view returns (bytes32, bytes32, uint8, uint256, uint256) {
    ...
    function ToggleFreezeToken(uint256 _tokenId) public onlyAdmins returns (bool){
    ...
    function CreateSpecialPlayer(bytes32 _name, bytes32 _position, uint8 _star, uint256 _dna, uint256 _level,
    ...
    function CreateDummyPlayer(bytes32 _name, bytes32 _position, uint256 _dna,
...
contract FootballPlayerOwnership is FootballPlayerBase, ERC721Metadata {

    string public name = "CryptoFantasyFootball";
    string public symbol = "CFF"; // Crypto Fantasy Football
    ...
    function tokenURI(uint256 _tokenId) public view returns (string){
        return strConcat(tokenURIBase,  uint2str(uint(players[_tokenId].dna)) );
    }
    ...
    //"CryptoFantasyFootball", "CFF" , "http://localhost:8080/api/meta/dna/"
    function setMetadataAddress(string _name, string _symbol, string _baseURI) public onlyMainAdmin {
        name = _name;
        symbol = _symbol;
        tokenURIBase = _baseURI;
    }
